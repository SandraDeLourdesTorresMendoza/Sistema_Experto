...
public class INSTRUCCIONES extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("1.- Este test esta compuesto por 10 imagenes con diferentes manchas de ");

        INSTRUCCIONES.setFont(new java.awt.Font("Century", 1, 14)); // NOI18N
        ...
        jLabel4.setText("tinta, el sujeto observara e interpretara las manchas abstractras, eligiendo una de ");

        jLabel6.setFont(new java.awt.Font("Century", 1, 12)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(0, 0, 51));
        jLabel6.setText("las opciones que se mostraran dentro del test.");

        jLabel7.setFont(new java.awt.Font("Century", 1, 12)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(0, 0, 51));
        jLabel7.setText("2.- El limite de tiempo por cada una de imagenes es de 1min");

        jLabel8.setFont(new java.awt.Font("Century", 1, 12)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(0, 0, 51));
        jLabel8.setText("3.- El test sera aplicado en observacion de un profecional,");

        jLabel9.setFont(new java.awt.Font("Century", 1, 12)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(0, 0, 51));
        jLabel9.setText("ya que es como una entresvista de indetificacion de imagenes ");

        jLabel10.setFont(new java.awt.Font("Century", 1, 12)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(0, 0, 51));
        jLabel10.setText("4.-Dentro del test no hay repuestas incorrectas ");

        jLabel11.setFont(new java.awt.Font("Century", 1, 12)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(0, 0, 51));
        jLabel11.setText("5.-El consumo de sustancias en un lapzo de 24hrs afecta a los resultados del ");

        jLabel12.setFont(new java.awt.Font("Century", 1, 12)); // NOI18N
        jLabel12.setForeground(new java.awt.Color(0, 0, 51));
        jLabel12.setText("paciente, es necesario hacerlo en las mejores condiciones.");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(INSTRUCCIONES, javax.swing.GroupLayout.PREFERRED_SIZE, 149, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(INSTRUCCIONES, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addComponent(LOGO))
                .addGap(34, 34, 34)
